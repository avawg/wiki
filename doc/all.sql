...
insert into `t_ebook` (id, name, description) values (1, 'Spring Boot 入门教程', '零基础入门 Java 开发，企业级应用开发最佳首选框架');
insert into `t_ebook` (id, name, description) values (2, 'Vue 入门教程', '零基础入门 Vue 开发，企业级应用开发最佳首选框架');
...
insert into `t_category` (id, parent_id, name, sort) values (102, 100, 'HTML & CSS', 102);
...
insert into `t_category` (id, parent_id, name, sort) values (500, 000, '其它', 500);
...
insert into `t_category` (id, parent_id, name, sort) values (503, 500, '热门服务端语言', 503);
...
insert into `t_doc` (id, ebook_id, parent_id, name, sort, view_count, vote_count) values (2, 1, 1, '文档1.1', 1, 0, 0);
insert into `t_doc` (id, ebook_id, parent_id, name, sort, view_count, vote_count) values (3, 1, 0, '文档2', 2, 0, 0);
insert into `t_doc` (id, ebook_id, parent_id, name, sort, view_count, vote_count) values (4, 1, 3, '文档2.1', 1, 0, 0);
insert into `t_doc` (id, ebook_id, parent_id, name, sort, view_count, vote_count) values (5, 1, 3, '文档2.2', 2, 0, 0);
insert into `t_doc` (id, ebook_id, parent_id, name, sort, view_count, vote_count) values (6, 1, 5, '文档2.2.1', 1, 0, 0);
